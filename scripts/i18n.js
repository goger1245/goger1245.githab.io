(function (global) {
  ...
  const DICT = Object.freeze({
    en: {
      ...
      mode_idle: "IDLE",
      nav_about: "01_ABOUT",
      nav_skills: "02_SKILLS",
      nav_projects: "03_DETAILS",
      nav_payment: "04_PAYMENT",
      nav_contact: "05_CONTACT",
      ...
      skills_hint: "Hover nodes to explore",
      skills_adapted: "System adapted to this node",
    ...
    ru: {
      ...
      nav_skills: "02_НАВЫКИ",
      nav_projects: "03_ДЕТАЛИ",
      nav_payment: "04_ОПЛАТА",
      nav_contact: "05_КОНТАКТЫ",
      about_name: "имя: Goga",
      ...
      skills_hint: "Наведи на узлы, чтобы изучить",
      skills_adapted: "Система адаптирована под этот узел",
